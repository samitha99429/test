import {
  ...
  import VaccineCardList from "../components/VaccineCardList/VaccineCardList";
  import { ScrollView } from "react-native-gesture-handler";
  
  const VaccineProcess = () => {
    ...
    return (
      <View>
        ...
        <Text style={styles.title}>vaccination Process</Text>
        <VaccineCardList vaccineList={vaccineList}/>
